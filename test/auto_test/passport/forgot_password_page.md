# `page/passport/forgot_password_page.dart`
...
|---|---|---|---|---|---|---|---|---|---|
| 无待办 | - | `page/passport/forgot_password_page.dart` | 展示找回密码页标题 | 已通过 | 批次24续3 | 0 | 0 | 0 | |
| 无待办 | - | `page/passport/forgot_password_page.dart` | 渲染并切换邮箱 tab | 已通过 | 批次24续3 | 0 | 0 | 0 | |
| 无待办 | - | `page/passport/forgot_password_page.dart` | 渲染并切换手机 tab | 已通过 | 批次24续3 | 0 | 0 | 0 | |
| 无待办 | - | `page/passport/forgot_password_page.dart` | 渲染并输入邮箱字段 | 已通过 | 批次24续3 | 0 | 0 | 0 | |
