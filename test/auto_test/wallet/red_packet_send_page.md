...
| 阻塞 | 需余额>0 且用户授权 | `page/wallet/red_packet_send_page.dart` | 二次确认展示收款人昵称 | 待重验 | - | 1 | 1 | 0 | BUG#111 同源；批次32 复核：修复 74b67501（08-06）已在 APK（14:55）内，但钱包实测余额 ¥0.00，发送 0.01 元即被「超出余额」校验拦截，二次确认弹窗不可达，条件不具备转阻塞 |
