...
| 待首测 | 2026-08-07 | `page/personal_info/set_gender/set_gender_page.dart` | 保存中禁用其余选项点击 | 未测 | - | 0 | 0 | 0 | |
| 回归复测 | 2026-08-07 | `page/personal_info/set_gender/set_gender_page.dart` | 选中项前置图标底色变主题蓝 | 待重验 | - | 0 | 0 | 0 | |
| 待首测 | 2026-08-07 | `page/personal_info/set_gender/set_gender_page.dart` | 保存失败时停留当前页不退栈 | 未测 | - | 0 | 0 | 0 | |
