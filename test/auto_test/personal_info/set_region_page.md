...
|---|---|---|---|---|---|---|---|---|---|
| 无待办 | - | ``page/personal_info/set_region/set_region_page.dart`` | 进页初始化并回显当前地区 | 已通过 | 批次80 | 0 | 0 | 0 | 批次80 回归确认：批次详验真机/代码证据充分，稳定功能无回归 |
...
| 无待办 | - | ``page/personal_info/set_region/set_region_page.dart`` | 已选地区回显区高亮加粗显示 | 已通过 | 批次80 | 0 | 0 | 0 | 批次80 回归确认：批次详验真机/代码证据充分，稳定功能无回归 |
...
| 无待办 | - | ``page/personal_info/set_region/set_region_page.dart`` | 含子级项显示箭头并进入子页 | 已通过 | 批次80 | 0 | 0 | 0 | 批次80 回归确认：批次详验真机/代码证据充分，稳定功能无回归 |
| 无待办 | - | ``page/personal_info/set_region/set_region_page.dart`` | 点叶子节点更新选择路径 | 已通过 | 批次80 | 0 | 0 | 0 | 批次80 回归确认：批次详验真机/代码证据充分，稳定功能无回归 |
...
| 无待办 | - | ``page/personal_info/set_region/set_region_page.dart`` | 完成按钮按有无变更启用置灰 | 已通过 | 批次80 | 0 | 0 | 0 | 批次80 回归确认：批次详验真机/代码证据充分，稳定功能无回归 |
