...
| 待首测 | 2026-08-07 | `page/personal_info/set_region/set_region_page.dart` | 顶部搜索框防抖过滤地区列表 | 未测 | - | 0 | 0 | 0 | 300ms 防抖 |
| 回归复测 | 2026-08-07 | `page/personal_info/set_region/set_region_page.dart` | 已选地区回显区高亮加粗显示 | 待重验 | - | 0 | 0 | 0 | |
| 待首测 | 2026-08-07 | `page/personal_info/set_region/set_region_page.dart` | 有变更时显示还原按钮 | 未测 | - | 0 | 0 | 0 | |
| 待首测 | 2026-08-07 | `page/personal_info/set_region/set_region_page.dart` | 点还原恢复到进页初始选择 | 未测 | - | 0 | 0 | 0 | |
