...
|---|---|---|---|---|---|---|---|---|---|
| 无待办 | - | ``page/personal_info/set_nickname/set_nickname_page.dart`` | 输入框自动聚焦并回填当前昵称 | 已通过 | 批次80 | 0 | 0 | 0 | 批次80 回归确认：批次详验真机/代码证据充分，稳定功能无回归 |
...
| 无待办 | - | ``page/personal_info/set_nickname/set_nickname_page.dart`` | 超出长度时计数变红警示 | 已通过 | 批次80 | 0 | 0 | 0 | 批次80 回归确认：批次详验真机/代码证据充分，稳定功能无回归 |
| 无待办 | - | ``page/personal_info/set_nickname/set_nickname_page.dart`` | 非法输入展示校验错误提示行 | 已通过 | 批次80 | 0 | 0 | 0 | 批次80 回归确认：批次详验真机/代码证据充分，稳定功能无回归 |
| 无待办 | - | ``page/personal_info/set_nickname/set_nickname_page.dart`` | 保存按钮按可保存态启用或置灰 | 已通过 | 批次80 | 0 | 0 | 0 | 批次80 回归确认：批次详验真机/代码证据充分，稳定功能无回归 |
| 无待办 | - | ``page/personal_info/set_nickname/set_nickname_page.dart`` | 点保存收起键盘并提交昵称 | 已通过 | 批次80 | 0 | 0 | 0 | 批次80 回归确认：批次详验真机/代码证据充分，稳定功能无回归 |
...
| 无待办 | - | ``page/personal_info/set_nickname/set_nickname_page.dart`` | 保存成功退栈并回传刷新标志 | 已通过 | 批次80 | 0 | 0 | 0 | 批次80 回归确认：批次详验真机/代码证据充分，稳定功能无回归 |
...
| 无待办 | - | ``page/personal_info/set_nickname/set_nickname_page.dart`` | 输入达24字符时硬截断 | 已通过 | 批次80 | 0 | 0 | 0 | 批次80 回归确认：批次详验真机/代码证据充分，稳定功能无回归 |
