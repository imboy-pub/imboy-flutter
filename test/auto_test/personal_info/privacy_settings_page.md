...
| 无待办 | - | ``page/personal_info/profile/widgets/privacy_settings.dart`` | A 关闭后 B 好友列表显示 A 离线 | 已通过 | 批次80 | 0 | 0 | 0 | 批次80 回归确认：批次详验真机/代码证据充分，稳定功能无回归 |
| 无待办 | - | ``page/personal_info/profile/widgets/privacy_settings.dart`` | A 开启后 B 看到 A 在线 | 已通过 | 批次80 | 0 | 0 | 0 | 批次80 回归确认：批次详验真机/代码证据充分，稳定功能无回归 |
| 无待办 | - | ``page/personal_info/profile/widgets/privacy_settings.dart`` | 会话免打扰不弹窗、@ 时弹窗 | 已通过 | 批次80 | 0 | 0 | 0 | 批次80 回归确认：批次详验真机/代码证据充分，稳定功能无回归 |
