...
|---|---|---|---|---|---|---|---|---|---|
| 无待办 | - | ``page/mine/mine/mine_page.dart`` | 渲染头像昵称名片卡片 | 已通过 | 批次80 | 0 | 0 | 0 | 批次80 回归确认：批次详验真机/代码证据充分，稳定功能无回归 |
| 无待办 | - | ``page/mine/mine/mine_page.dart`` | 无头像时显示首字母兜底 | 已通过 | 批次80 | 0 | 0 | 0 | 批次80 回归确认：批次详验真机/代码证据充分，稳定功能无回归 |
| 无待办 | - | ``page/mine/mine/mine_page.dart`` | 展示账号 ID 文本 | 已通过 | 批次80 | 0 | 0 | 0 | 批次80 回归确认：批次详验真机/代码证据充分，稳定功能无回归 |
