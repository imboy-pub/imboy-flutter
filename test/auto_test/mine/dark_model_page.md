...
| 回归复测 | 2026-08-07 | `page/mine/dark_model/dark_model_page.dart` | 重复点击已选项时不重复切换 | 待重验 | §十七 | 0 | 0 | 0 | |
| 回归复测 | 2026-08-07 | `page/mine/dark_model/dark_model_page.dart` | 进入页面时回显当前主题状态 | 待重验 | §十七 | 0 | 0 | 0 | |
| 回归复测 | 2026-08-07 | `page/mine/dark_model/dark_model_page.dart` | 关闭跟随系统后回落实际亮暗 | 待重验 | §十七 | 0 | 0 | 0 | |
| 回归复测 | 2026-08-07 | `page/mine/dark_model/dark_model_page.dart` | 渲染显示与主题分组标题 | 待重验 | §十七 | 0 | 0 | 0 | |
