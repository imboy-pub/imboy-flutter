...
| 回归复测 | 2026-08-07 | `page/group/group_detail/remove_member_page.dart` | 加载群成员列表并排除自己 | 待重验 | - | 0 | 0 | 0 | |
| 回归复测 | 2026-08-07 | `page/group/group_detail/remove_member_page.dart` | 点成员行切换勾选状态 | 待重验 | - | 0 | 0 | 0 | |
| 回归复测 | 2026-08-07 | `page/group/group_detail/remove_member_page.dart` | 完成按钮随选中数高亮变化 | 待重验 | - | 0 | 0 | 0 | |
