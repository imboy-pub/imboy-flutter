...
| 回归复测 | 2026-08-07 | `page/group/group_detail/group_detail_page.dart` | 点群信息卡片进入改群名页 | 待重验 | - | 0 | 0 | 0 | |
| 回归复测 | 2026-08-07 | `page/group/group_detail/group_detail_page.dart` | 编辑我的群昵称并落库 | 待重验 | - | 0 | 0 | 0 | |
| 回归复测 | 2026-08-07 | `page/group/group_detail/group_detail_page.dart` | 编辑群备注并落库 | 待重验 | - | 0 | 0 | 0 | |
| 回归复测 | 2026-08-07 | `page/group/group_detail/group_detail_page.dart` | 切换消息免打扰开关 | 待重验 | - | 0 | 0 | 0 | |
