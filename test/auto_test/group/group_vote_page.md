# `page/group/vote/group_vote_page.dart`
...
|---|---|---|---|---|---|---|---|---|---|
| 无待办 | - | `page/group/vote/group_vote_page.dart` | 加载并渲染群投票列表 | 已通过 | 首轮 | 0 | 0 | 0 | |
...
| 回归复测 | 2026-08-07 | `page/group/vote/group_vote_page.dart` | 参与人数缺失时兜底取总票数 | 待重验 | - | 0 | 0 | 0 | |
| 回归复测 | 2026-08-07 | `page/group/vote/group_vote_page.dart` | 区分空态与加载失败重试入口 | 待重验 | - | 0 | 0 | 0 | |
| 回归复测 | 2026-08-07 | `page/group/vote/group_vote_page.dart` | 投票ID缺失时提示不跳转 | 待重验 | - | 0 | 0 | 0 | |
