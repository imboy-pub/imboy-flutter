...
| 回归复测 | 2026-08-07 | `page/group/face_to_face/face_to_face_confirm_page.dart` | 展示四位暗号数字与锁标签 | 待重验 | - | 0 | 0 | 0 | |
| 回归复测 | 2026-08-07 | `page/group/face_to_face/face_to_face_confirm_page.dart` | 提交中按钮禁用并显示转圈 | 待重验 | - | 0 | 0 | 0 | |
| 回归复测 | 2026-08-07 | `page/group/face_to_face/face_to_face_confirm_page.dart` | 呼吸绿点动画持续闪烁 | 待重验 | - | 0 | 0 | 0 | |
| 回归复测 | 2026-08-07 | `page/group/face_to_face/face_to_face_confirm_page.dart` | 点返回退出建群确认页 | 待重验 | - | 0 | 0 | 0 | |
