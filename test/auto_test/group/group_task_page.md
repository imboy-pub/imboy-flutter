# `page/group/task/group_task_page.dart`
...
|---|---|---|---|---|---|---|---|---|---|
| 回归复测 | 2026-08-07 | `page/group/task/group_task_page.dart` | 加载并渲染群作业任务列表 | 待重验 | - | 0 | 0 | 0 | |
...
| 回归复测 | 2026-08-07 | `page/group/task/group_task_page.dart` | 截止倒计时文案与超期配色 | 待重验 | - | 0 | 0 | 0 | |
| 回归复测 | 2026-08-07 | `page/group/task/group_task_page.dart` | 已截止任务标题划线并置灰 | 待重验 | - | 0 | 0 | 0 | |
| 回归复测 | 2026-08-07 | `page/group/task/group_task_page.dart` | 区分空态与失败态并给重试 | 待重验 | - | 0 | 0 | 0 | |
| 回归复测 | 2026-08-07 | `page/group/task/group_task_page.dart` | 任务ID缺失时提示不跳转 | 待重验 | - | 0 | 0 | 0 | |
