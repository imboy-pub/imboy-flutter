...
| 回归复测 | 2026-08-07 | `page/group/group_detail/change_info_page.dart` | 输入群名实时同步到状态 | 待重验 | - | 0 | 0 | 0 | |
| 回归复测 | 2026-08-07 | `page/group/group_detail/change_info_page.dart` | 点清除图标一键清空输入 | 待重验 | - | 0 | 0 | 0 | |
| 回归复测 | 2026-08-07 | `page/group/group_detail/change_info_page.dart` | 完成按钮随内容变更切换高亮 | 待重验 | - | 0 | 0 | 0 | |
