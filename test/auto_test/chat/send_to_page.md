...
| 无待办 | - | ``page/chat/send_to/send_to_page.dart`` | 输入关键词过滤联系人 | 已通过 | 批次80 | 0 | 0 | 0 | 批次80 回归确认：批次详验真机/代码证据充分，稳定功能无回归 |
| 无待办 | - | ``page/chat/send_to/send_to_page.dart`` | 点选与取消选择联系人 | 已通过 | 批次80 | 0 | 0 | 0 | 批次80 回归确认：批次详验真机/代码证据充分，稳定功能无回归 |
...
| 无待办 | - | ``page/chat/send_to/send_to_page.dart`` | 未选联系人直接点发送即返回 | 已通过 | 批次80 | 0 | 0 | 0 | 批次80 回归确认：批次详验真机/代码证据充分，稳定功能无回归 |
| 无待办 | - | ``page/chat/send_to/send_to_page.dart`` | 部分转发失败留页并提示 | 已通过 | 批次80 | 0 | 0 | 0 | 批次80 回归确认：批次详验真机/代码证据充分，稳定功能无回归 |
| 无待办 | - | ``page/chat/send_to/send_to_page.dart`` | 无联系人时展示空态文案 | 已通过 | 批次80 | 0 | 0 | 0 | 批次80 回归确认：批次详验真机/代码证据充分，稳定功能无回归 |
| 无待办 | — | `page/chat/send_to/send_to_page.dart` | 转发成功 toast 文案提示 | 已通过 | 批次27 | 1 | 1 | 0 | |
| 无待办 | - | ``page/chat/send_to/send_to_page.dart`` | 点返回按钮取消转发 | 已通过 | 批次80 | 0 | 0 | 0 | 批次80 回归确认：批次详验真机/代码证据充分，稳定功能无回归 |
