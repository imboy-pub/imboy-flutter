...
void main() {
  group('DefaultAppDowngradeCleaner.onDowngrade', () {
    ...
    test('清理升级提示 dismiss 状态 / purges upgrade dismiss records', () async {
    ...
    test('保留用户身份与业务数据 / preserves identity and business data', () async {
      // 模拟用户身份与业务缓存
    ...
    test('对不存在的 key 也不报错 / idempotent on absent keys', () async {
      // 所有 key 都不存在
      expect(
