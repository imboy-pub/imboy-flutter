  ...
  group('CellPressable', () {
    testWidgets('renders child untouched at idle', (tester) async {
      await tester.pumpWidget(
        _wrap(CellPressable(onTap: () {}, child: const Text('hello'))),
      );
    ...
    testWidgets('highlights with dark theme color (~6% white) while pressed', (
      tester,
    ) async {
      await tester.pumpWidget(
        _wrap(
    ...
    testWidgets('restores to transparent when tap is cancelled (drag away)', (
      tester,
    ) async {
      await tester.pumpWidget(
        _wrap(
    ...
    testWidgets('when onTap and onLongPress are both null: ignores press '
        '(no highlight, no callback)', (tester) async {
      var tapCount = 0;
      await tester.pumpWidget(
        _wrap(
          CellPressable(
    ...
    testWidgets('when only onLongPress is provided (no onTap): highlights and '
        'long-press still works', (tester) async {
      var longPressCount = 0;
      await tester.pumpWidget(
        _wrap(
          CellPressable(
