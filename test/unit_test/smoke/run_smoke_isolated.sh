...
#
# 用法 / Usage:
#   bash test/unit_test/smoke/run_smoke_isolated.sh
#   bash test/unit_test/smoke/run_smoke_isolated.sh --quiet   # 仅打印汇总与失败项
#
...
TEST_FILE="test/unit_test/smoke/route_smoke_test.dart"
REGISTRY="test/unit_test/smoke/route_registry.dart"
QUIET="${1:-}"
