...
// Path: agent
class _Translations$agent$it_IT extends Translations$agent$zh_CN {
	_Translations$agent$it_IT._(TranslationsItIt root) : this._root = root, super.internal(root);

	final TranslationsItIt _root; // ignore: unused_field

	// Translations
	@override String get plazaTitle => 'Assistenti IA';
	@override String get transparencyBanner => 'Tutti i membri qui sono assistenti IA, chiaramente identificati. Nelle chat crittografate ci sono solo persone reali.';
	@override String get searchHint => 'Cerca assistenti';
	@override String get emptyTitle => 'Nessun assistente IA al momento. Torna più tardi.';
	@override String get searchEmpty => 'Nessun assistente corrispondente';
	@override String get sendMessage => 'Messaggio';
...
// Path: billing
class _Translations$billing$it_IT extends Translations$billing$zh_CN {
	_Translations$billing$it_IT._(TranslationsItIt root) : this._root = root, super.internal(root);

	final TranslationsItIt _root; // ignore: unused_field

	// Translations
	@override String get title => 'Abbonamenti';
	@override String get planPeriodMonthly => 'Mensile';
	@override String get planPeriodYearly => 'Annuale';
	@override String get subscribe => 'Abbonati ora';
	@override String get currentPlan => 'Piano attuale';
	@override String get noPlans => 'Nessun piano ancora disponibile. A breve';
	@override String get loadFailed => 'Caricamento non riuscito. Scorri per riprovare';
	@override String get retry => 'Riprova';
	@override String get paySuccess => 'Abbonamento riuscito';
	@override String get payFailed => 'Pagamento non riuscito';
	@override String get payCancelled => 'Pagamento annullato';
	@override String get payMethodTitle => 'Scegli un metodo di pagamento';
	@override String get payMethodMock => 'Pagamento di test (solo sviluppo)';
	@override String get payMethodAlipay => 'Alipay';
	@override String get payMethodWechat => 'WeChat Pay';
	@override String get payMethodComingSoon => 'Questo metodo di pagamento sarà disponibile a breve';
	@override String get quotaUnlimited => 'Illimitato';
}
...
class _Translations$common$it_IT extends Translations$common$zh_CN {
	...
	@override String timeDaysAgo({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('it'))(n,
		one: '${n} giorno fa',
		other: '${n} giorni fa',
	);
	@override String timeHoursAgo({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('it'))(n,
		one: '${n} ora fa',
		other: '${n} ore fa',
	);
	@override String get timeJustNow => 'Proprio ora';
	@override String timeMinutesAgo({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('it'))(n,
		one: '${n} minuto fa',
		other: '${n} minuti fa',
	);
	...
	@override String get turnOffFlashlight => 'Spegni il flash';
	@override String get pauseScan => 'Metti in pausa la scansione';
...
class _Translations$mention$it_IT extends Translations$mention$zh_CN {
	...
	// Translations
	@override String get mentionAll => 'Tutti';
	@override String get mentionAllHint => 'Notifica tutti i membri del gruppo';
	@override String get noMatchedMember => 'Nessun membro corrispondente';
	@override String get selectMention => 'Scegli un membro da menzionare';
...
class _Translations$passport$it_IT extends Translations$passport$zh_CN {
	...
	@override String get loginHistoryToggle => 'Mostra cronologia accessi';
...
extension on TranslationsItIt {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'agent.emptyTitle' => 'Nessun assistente IA al momento. Torna più tardi.',
			'agent.searchEmpty' => 'Nessun assistente corrispondente',
			...
			'billing.subscribe' => 'Abbonati ora',
			'billing.currentPlan' => 'Piano attuale',
			'billing.noPlans' => 'Nessun piano ancora disponibile. A breve',
			'billing.loadFailed' => 'Caricamento non riuscito. Scorri per riprovare',
			'billing.retry' => 'Riprova',
			'billing.paySuccess' => 'Abbonamento riuscito',
			'billing.payFailed' => 'Pagamento non riuscito',
			'billing.payCancelled' => 'Pagamento annullato',
			'billing.payMethodTitle' => 'Scegli un metodo di pagamento',
			'billing.payMethodMock' => 'Pagamento di test (solo sviluppo)',
			'billing.payMethodAlipay' => 'Alipay',
			'billing.payMethodWechat' => 'WeChat Pay',
			'billing.payMethodComingSoon' => 'Questo metodo di pagamento sarà disponibile a breve',
			'billing.quotaUnlimited' => 'Illimitato',
			...
			'common.turnOffFlashlight' => 'Spegni il flash',
			'common.pauseScan' => 'Metti in pausa la scansione',
			...
			'mention.selectMention' => 'Scegli un membro da menzionare',
			...
			'passport.loginHistoryToggle' => 'Mostra cronologia accessi',
