...
| `chat/` | 聊天相关组件 | `message.dart`, `message_image_builder.dart` |
...
### 聊天组件
- `lib/component/chat/message.dart` - 消息基类
- `lib/component/chat/message_image_builder.dart` - 图片消息
- `lib/component/chat/message_video_builder.dart` - 视频消息
