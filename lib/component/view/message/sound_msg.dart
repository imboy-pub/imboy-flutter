...
//     bool isSelf = widget.model.from_id == global.uid;
//     var soundImg;
//     var leftSoundNames = [
...
//     }
//
//     SoundMsgEntity model =
//         SoundMsgEntity.fromJson(widget.model.payload.toMap());
//     ISoundMsgEntity iModel =
//         ISoundMsgEntity.fromJson(widget.model.payload.toMap());
//     bool isIos = Platform.isIOS;
//     if (!listNoEmpty(isIos ? iModel.soundUrls : model.urls)) return Container();
//
//     var urls = isIos ? iModel.soundUrls[0] : model.urls[0];
//     var body = [
//       new MsgAvatar(model: widget.model, global: global),
//       new Container(
//         width: 100.0,
...
//           color: widget.model.fromId == global.uid
//               ? Color(0xff98E165)
//               : Colors.white,
//           onPressed: () {
//             if (strNoEmpty(urls)) {
