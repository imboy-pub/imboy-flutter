...
class CheckNewFriendLogic extends GetxController {
  // 聊天、朋友圈、运动数据等
  ...
  void setRole(String role) {
    // debugPrint(">>> on CheckNewFriendLogic/setRole1 ${this.role.value} = ${role}");
    this.role.value = role;
    update([this.role]);

    // debugPrint(">>> on CheckNewFriendLogic/setRole2 ${this.role.value} = ${role}");
  }
