...
import 'package:imboy/service/websocket.dart' show SocketStatus, WebSocketService;
            ...
            BottomNavigationBarItem(
              icon: badges.Badge(
                ...
                badgeStyle: badges.BadgeStyle(
                  badgeColor:
                  WebSocketService.to.status.value == SocketStatus.connected ? Colors.green : Colors.red,
                ),
