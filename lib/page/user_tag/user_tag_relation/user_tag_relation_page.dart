            ...
            return Container(
              ...
              child: TextField(
                ...
                onSubmitted: (String tag) {
                  ...
                  if (s2.items != null && !s2.items!.contains(tag)) {
                    s2.items = List.from(s2.items!)..add(tag);
                  }
              ...
              child: FilterListWidget<String>(
                ...
                themeData: FilterListThemeData(
                  ...
                  choiceChipTheme: ChoiceChipThemeData(
                    ...
                    selectedBackgroundColor: AppColors.getIosBlue(
                      brightness,
                ...
                onApplyButtonClick: (list) async {
                  ...
                  for (var t in tags) {
                    _tagController.onTagRemoved(t);
                  }
                  for (var t in tagItems) {
                    _tagController.addTag(t);
                  }
                  if (buildTagSyncPlan(
                ...
                onItemSearch: (item, query) {
                  ...
                  if (PinyinHelper.getPinyinE(
                    item,
                    separator: '',
                    format: PinyinFormat.WITHOUT_TONE,
                  ).toLowerCase().contains(q))
                    return true;
                  if (PinyinHelper.getShortPinyin(
                    item,
                  ).toLowerCase().contains(q))
                    return true;
                  return false;
