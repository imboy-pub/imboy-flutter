        ...
        builder: (context, orientation) {
          return Column(children: <Widget>[
            Column(children: <Widget>[
              ...
              //             borderSide: BorderSide(color: ThemeManager.instance.getThemeColor('border'))),
              //         enabledBorder: UnderlineInputBorder(
              //             borderSide: BorderSide(color: ThemeManager.instance.getThemeColor('border'))),
              //         focusedBorder: UnderlineInputBorder(
              //             borderSide: BorderSide(color: ThemeManager.instance.getThemeColor('primary'))),
              //       ),
              //     ),
              //   )
            ]),
            ...
            //       decoration: BoxDecoration(color: ThemeManager.instance.getThemeColor('background')),
