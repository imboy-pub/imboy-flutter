...
- Route and page-barrel entry points now converge on module public entries for `moment_social`, `channel_content`, `group_collab`, `social_graph`, `security_privacy`, and `ops_governance`; legacy `page/*` and `service/*` files still act as the domain-owned implementation roots behind those entries.
...
- Compatibility wrappers intentionally retained: `lib/service/message.dart`, `lib/service/message_actions.dart`, `lib/service/group_vote_service.dart`, `lib/service/group_schedule_service.dart`, `lib/service/group_task_service.dart`, `lib/service/e2ee_service.dart`, `lib/service/e2ee_key_service.dart`, `lib/service/mention_service.dart`, `lib/page/passport/passport_notifier.dart`, `lib/page/mine/user_collect/user_collect_page.dart`.
