// P0 Demo Flow：已有 C2C 会话 → 单聊页面（只读）。
...
void main() {
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final item = await waitForConversationType(tester, 'C2C');
      if (item == null) {
        markTestSkipped('当前账号没有可识别的已有 C2C 会话');
        return;
      }
      ...
      flowLog('P0 单聊 Demo Flow：ChatPage 已打开，未输入或发送消息');
